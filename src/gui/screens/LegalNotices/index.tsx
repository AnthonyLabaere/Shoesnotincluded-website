...
const LegalNotices = (): React.ReactElement => {
  return (
    <>
      <Helmet>
        <title>Escape Game - Mentions Légales - ShoesNotIncluded</title>
        <meta
          name="description"
          content="Consultez les mentions légales de ShoesNotIncluded pour connaître les informations juridiques de notre site et en savoir plus sur notre application mobile."
        />
      </Helmet>
      <PageContainer>
        <InnerPageContainer>
              ...
              <div>
                ...
                <div>
                  <p>
                    ...
                    ShoesNotIncluded, auto-entreprise au nom de Anthony Labaere immatriculée au RCS
                    de Nantes sous le numéro 904833167, dont le siège social est sis au 25 rue Jules
