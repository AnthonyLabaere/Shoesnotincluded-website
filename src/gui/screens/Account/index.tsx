...
const Account = (): React.ReactElement => {
  ...
  const helmet = (
    <Helmet>
      <title>Mon compte et mes bons d&apos;achat - ShoesNotIncluded</title>
      <meta
        name="description"
        content="Accédez à votre compte utilisateur ShoesNotIncluded pour consulter vos achats et vos bons d'achats associées à vos parties d'escape game en extérieur."
      />
    </Helmet>
  );
    ...
    <>
      ...
      <PageContainer>
        ...
        <Modal
          ...
          <div>
            Attention, la suppression de votre compte entraînera la suppression de toutes vos
            données.
          </div>
          <ButtonsContainer>
            <DeleteButton
