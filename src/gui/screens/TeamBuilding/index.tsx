          ...
          <ContentContainer>
            <TextContainer>
              ...
              <p style={{ marginBottom: 50 }}>
                ...
                le groupe de hackers <b>4N0NYM0U5DU44</b>. Ils ont la main sur l&apos;intégralité
                des données de votre entreprise mais heureusement pour vous, ils vous laissent une
                chance de les sauver. Ils considèrent Nantes comme un lieu historique trop méconnu,
                et sont outrés du manque de connaissance de vos équipes sur l&apos;histoire locale.
                Résolvez les énigmes réalisées par leur soin et prouvez que vous êtes méritant de
                l&apos;héritage culturel de la ville. Vous n&apos;avez que peu de temps avant que
                l&apos;intégralité de votre base de données soit définitivement effacée. Vous
                n&apos;avez pas le choix, vous devez vous plier à leur exigence.
              </p>
              <p>
                Pendant approximativement 2h, vos collaborateurs devront résoudre les énigmes
                d&apos;un escape game plein air et géolocalisé sur application mobile, leur faisant
                traverser la ville pour en découvrir ou redécouvrir certains principaux lieux
              ...
              <p>
                Le scénario est composé d&apos;une série d&apos;étapes qui peuvent être appréhendées
                comme les différentes salles d&apos;un escape game. Et comme dans un escape game,
                vos collaborateurs devront travailler ensemble pour avancer dans le jeu.
              </p>
              <p>
              ...
              <ul>
                ...
                <li>
                  le contenu de chaque étape est conçu de manière à ne pas pouvoir être résolu seul
                  : que ce soit par l&apos;entremêlement des énigmes, la quantité d&apos;information
                  ou plus simplement le support qui nécessite d&apos;être à plusieurs sur certaines
                  énigmes.
                </li>
              </ul>
              <p>
              ...
              <p>
                Un accompagnateur gérera le départ des équipes et les attendra à la fin du parcours
                pour un debriefing.
              </p>
