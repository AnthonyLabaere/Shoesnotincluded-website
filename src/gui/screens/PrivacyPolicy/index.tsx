...
const PrivacyPolicy = (): React.ReactElement => {
  return (
    <>
      <Helmet>
        <title>Politique de Confidentialité - ShoesNotIncluded</title>
        <meta
          name="description"
          content="Consultez notre politique de confidentialité pour connaître les informations sur la protection de vos données personnelles chez ShoesNotIncluded."
        />
      </Helmet>
      <PageContainer>
        <InnerPageContainer>
            ...
            <PrivacyPolicyContentContainer>
              <div>
                <div>
                  ...
                  <div>
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>« Service »</strong> : le service https://www.shoesnotincluded.fr/
                      ...
                      <li>
                        ...
                        auto-entreprise au nom de Anthony Labaere responsable de l&apos;édition et
                        du contenu du Service.
                      </li>
                      <li>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      que vous soyez conscient des raisons pour lesquelles nous utilisons vos
                ...
                <div>
                  ...
                  <div>
                    <p>
                      ...
                      contenus, vous pourrez être amenés à transmettre des Données vous concernant à
                      des tiers partenaires au travers de leurs propres services, plus
                    ...
                    <p>
                      ...
                      est susceptible de mettre en œuvre un procédé automatique de traçage (Cookie),
                      auquel vous pouvez faire obstacle en modifiant les paramètres concernés de
                      votre navigateur internet, comme expliqué dans les conditions générales du
                      présent Service.
                    </p>
                    <p>
                      D&apos;une manière générale, il vous est possible de visiter le Service
                      https://www.shoesnotincluded.fr/ sans communiquer aucune information
                      personnelle vous concernant. Dans tous les cas, vous n&apos;avez aucune
                      obligation de transmettre ces informations. Néanmoins, en cas de refus, il se
                      peut que vous ne puissiez pas bénéficier de certaines informations ou
                      services.
                    </p>
                    <p>
                      ...
                      données ne révèlent pas directement votre identité. Par exemple, nous pouvons
                    ...
                    <p>
                      ...
                      informatique et liberté du 6 janvier 1978. Conformément à cette dernière, ils
                      disposent d&apos;un droit d&apos;accès, de retrait, de modification ou de
                      ...
                      contact@shoesnotincluded, ou par courrier : 25 rue Jules Piedeleu.
                    </p>
                    <p>
                      ...
                      des Données personnelles (la Commission Nationale de l&apos;Informatique et
                      des Libertés – CNIL).
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <ul>
                      ...
                      <li>
                        Aux fins de recueillir des informations nous permettant d&apos;améliorer
                        notre Service, nos produits et fonctionnalités (notamment par l&apos;usage
                        des cookies).
                      </li>
                    </ul>
                  </div>
                ...
                <div>
                  <h3>
                    <span style={{ marginLeft: 0 }}>
                      Article 5 - <span style={{ marginLeft: 10 }}></span>Destinataires et
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      notre Service, notamment dans le cadre de newsletters que vous avez acceptées.
                      Vous pouvez demander à ne plus recevoir ces courriers électroniques en nous
                      contactant à l&apos;adresse contact@shoesnotincluded ou sur le lien prévu à
                      cet effet dans chacun des courriers électroniques qui vous seront adressés.
                    </p>
                    <p>
                      ...
                      auxquels ShoesNotIncluded fait appel. Ni ShoesNotIncluded ni ses
                      sous-traitants ne procèdent à la commercialisation des données personnelles
                      des visiteurs et utilisateurs de son Service.
                    </p>
                    <p>
                ...
                <div>
                  <h3>
                    <span style={{ marginLeft: 0 }}>
                      Article 6 - <span style={{ marginLeft: 10 }}></span>Fondements légaux
                ...
                <div>
                  ...
                  <div>
                    ...
                    modifiées, dévoilées ou consultées sans autorisation. De plus, l&apos;accès à
                    vos données personnelles est soumis à une procédure de sécurité définie et
                    documentée.
                  </div>
                </div>
                  ...
                  <div>
                    <p>
                      <span>
                        ...
                        statistiques et ne donneront lieu à aucune exploitation, de quelque nature
                        que ce soit.
                      </span>
                    </p>
                  </div>
                ...
                <div>
                  ...
                  <div>
                    <p>
                      ShoesNotIncluded vous informe qu&apos;il a recours à des prestataires
                      habilités pour faciliter le recueil et le traitement des données que vous nous
                      avez communiquées. Ces prestataires peuvent être situés en dehors de
                      l&apos;Union Européenne et ont communication des données recueillies par le
                      biais des divers formulaires présents sur le Service.
                    </p>
                    <p>
                      ...
                      particulièrement, la vigilance s&apos;est portée sur l&apos;existence
                      d&apos;un fondement légal pour effectuer un quelconque transfert de données
                      vers un pays tiers. A ce titre, certains de nos prestataires sont soumis à des
                      règles internes d&apos;entreprise (ou « Binding Corporate Rules ») qui ont été
                ...
                <div>
                  ...
                  <div>
                    <p>
                      ...
                      l&apos;Article 1 de la Présente Politique de confidentialité en nous écrivant
                      à l&apos;adresse postale mentionnée en tête (25 rue Jules Piedeleu) ou en
                      envoyant un courriel à contact@shoesnotincluded :
                    </p>
                    <ul>
                      <li>
                        Le droit d&apos;information : nous avons l&apos;obligation de vous informer
                        de la manière dont nous utilisons vos données personnelles (tel que décrit
                      ...
                      <li>
                        ...
                        données personnelles vous concernant qui seraient incomplètes ou inexactes.
                      ...
                      <li>
                        ...
                        l&apos;oubli » : dans certains cas, vous pouvez nous demander de supprimer
                        les données personnelles que nous avons vous concernant (mis à part
                        s&apos;il existe une raison juridique impérieuse qui nous oblige à les
                        conserver).
                      </li>
                      <li>
                      ...
                      <li>
                        Le droit d&apos;opposition : vous avez le droit de vous opposer au
                        traitement de vos données personnelles (par exemple, en nous interdisant de
                        traiter vos données à des fins de marketing direct).
                      </li>
                    </ul>
                    <p>
                    ...
                    <p>
                      Contactez-nous si vous souhaitez exercer l&apos;un des droits décrits
                      ci-dessus en nous écrivant à 25 rue Jules Piedeleu ou par courriel à
                    ...
                    <p>
                      ...
                      pourrons vous facturer des frais raisonnables si votre demande est
                      manifestement infondée, répétitive ou excessive. Dans ce cas, nous pouvons
                      aussi refuser de répondre à votre demande.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      votre identité et d&apos;assurer votre droit d&apos;accès à vos données
                      personnelles (ou pour exercer tout autre droit). Il s&apos;agit d&apos;une
                      mesure de sécurité pour garantir que ces données personnelles ne soient pas
                      délivrées à une personne non autorisée à les recevoir. Nous pouvons aussi vous
                      contacter pour obtenir plus d&apos;informations concernant votre demande, afin
                      de vous donner une réponse plus rapide.
                    </p>
                    <p>
                      ...
                      demande est particulièrement complexe ou si vous en avez fait plusieurs. Dans
                      ce cas, nous vous préviendrons et vous tiendrons informé.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div>
                    <p>
                      ...
                      une demande auprès de l&apos;autorité compétente. En France, l&apos;autorité
                ...
                <div>
                  ...
                  <div>
                    <p>
                      ...
                      https://www.shoesnotincluded.fr/, vous êtes avertis par un bandeau que des
                      informations relatives à votre navigation sont susceptibles d&apos;être
                      enregistrées dans des fichiers alphanumériques dénommés « cookies ». Notre
                      politique d&apos;utilisation des cookies vous permet de mieux comprendre les
                      dispositions que nous mettons en œuvre en matière de navigation sur notre
                      Service. Elle vous informe notamment sur l&apos;ensemble des cookies présents
                      sur notre Service, leur finalité et vous donne la marche à suivre pour les
                      paramétrer.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div>
                    <p>
                      ShoesNotIncluded, en tant qu&apos;éditeur du présent Service, pourra procéder
                      à l&apos;implantation de cookies sur le disque dur de votre terminal
                      (ordinateur, tablette, mobile etc.) afin de vous garantir une navigation
                    ...
                    <p>
                      ...
                      d&apos;une communication auprès de tiers sauf lorsque ShoesNotIncluded a
                      obtenu au préalable votre consentement ou bien lorsque la divulgation de ces
                    ...
                    <p>
                      ...
                      vous trouverez un tableau listant les différents types de cookies susceptibles
                      d&apos;être utilisés sur le Service de ShoesNotIncluded, leur nom, leur
                      finalité ainsi que leur durée de conservation à l&apos;adresse{' '}
                ...
                <div>
                  <h3>
                    <span style={{ marginLeft: 30 }}>
                      b) <span style={{ marginLeft: 10 }}></span>Configuration de vos préférences
                      sur les cookies
                    </span>
                  </h3>
                  <div>
                    ...
                    <p>
                      Lors de votre première utilisation du Service
                      https://www.shoesnotincluded.fr/, une bannière présentant brièvement des
                      informations relatives au dépôt de cookies et de technologies similaires
                      apparaît en bas de votre écran. Cette bannière vous avertit qu&apos;en
                      poursuivant votre navigation sur le Service de ShoesNotIncluded (en chargeant
                      une nouvelle page ou en cliquant sur divers éléments du Service par exemple),
                      vous acceptez le dépôt de cookies sur votre terminal.
                    </p>
                    <p>
                      Selon le type de cookie en cause, le recueil de votre consentement au dépôt et
                      à la lecture de cookies sur votre terminal peut être impératif.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  <h3>
                    <span style={{ marginLeft: 30 }}>
                      c) <span style={{ marginLeft: 10 }}></span>Les cookies exemptés de
                      consentement
                    </span>
                  </h3>
                  <div>
                    <p>
                      ...
                      notamment des cookies d&apos;identifiant de session, d&apos;authentification,
                      de session d&apos;équilibrage de charge ainsi que des cookies de
                      personnalisation de votre interface. Ces cookies sont intégralement soumis à
                      la présente politique dans la mesure où ils sont émis et gérés par
                      ShoesNotIncluded.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      soumis à leurs propres politiques de confidentialité dont vous trouverez un
                      lien ci-dessous. Cette famille de cookie regroupe les cookies de mesure
                      ...
                      sont émis et gérés par l&apos;éditeur du réseau social concerné. Sous réserve
                      de votre consentement, ces cookies vous permettent de partager facilement une
                    ...
                    <p>
                      Les cookies de mesure d&apos;audience établissent des statistiques concernant
                      la fréquentation et l&apos;utilisation de divers éléments du Service (comme
                      les contenus / pages que vous avez visité). Ces données participent à
                ...
                <div>
                  ...
                  <div>
                    <p>
                      ...
                      qu&apos;une partie seulement des cookies soit acceptée ou refusée en fonction
                      de leur émetteur.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      tout le bénéfice apporté par le cookie.
                    </p>
                    <p>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      relative à la présente politique des cookies, merci de bien vouloir nous
                      contacter.
                    </p>
                  </div>
                </div>
