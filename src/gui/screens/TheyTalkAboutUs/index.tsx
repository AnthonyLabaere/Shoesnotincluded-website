...
const TheyTalkAboutUs = (): React.ReactElement => {
  return (
    <>
      <Helmet>
        <title>Escape Game - Ils parlent de nous - ShoesNotIncluded</title>
        <meta
          name="description"
          content="Retrouvez les articles et les interviews concernant ShoesNotIncluded et son concept d'escape game en extérieur sur notre page de presse."
        />
      </Helmet>
      <PageContainer>
        <InnerPageContainer>
