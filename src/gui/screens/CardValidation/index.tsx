...
const CardValidation = (): React.ReactElement => {
  ...
  useEffect(() => {
    if (redirectToAccount && voucherId !== undefined) {
      ...
      navigate('../compte', { state: { voucherId } });
    }
    ...
    <PageContainer>
        ...
        <ContentPageContainer>
          <Form onSubmit={formik.handleSubmit}>
            <InputContainer>
              ...
              <ErrorMessage>
                {formik.touched.voucherCardId === true && formik.errors.voucherCardId != null
            ...
            <InputContainer>
              ...
              />
              <ErrorMessage>
                {formik.touched.validationCode === true && formik.errors.validationCode != null
            ...
            <Button type="submit" disabled={formik.isSubmitting}>
              {formik.isSubmitting ? 'Validation en cours...' : 'Valider ma carte'}
            </Button>
          </Form>
      ...
      <Modal
        ...
        <ModalTextLine style={{ fontStyle: 'italic' }}>
          Pour l&apos;utiliser :<br />1 - Ouvrez l&apos;application ShoesNotIncluded (ou
          téléchargez-là au préalable sur les stores{' '}
          <StyledALink href={Constants.PLAY_STORE_LINK}>Android</StyledALink> ou{' '}
        ...
        <ModalTextLine style={{ marginTop: 25 }}>
          Un mail récapitulatif a été envoyé à l&apos;adresse mail associée à votre compte.
        </ModalTextLine>
