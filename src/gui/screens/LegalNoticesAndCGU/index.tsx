      ...
      <InnerPageContainer>
        ...
        <ContentPageContainer>
          <LegalNoticesTCUContentContainer>
            ...
            <p>Adresse du siège social: 25 rue Jules Piedeleu, 44100 Nantes</p>
            ...
            <ul>
              <li>la société Netlify, dont le siège social est situé au 2325 3rd Street, Suite 215 94107 San Francisco, USA.</li>
              <li>la société Firebase, dont le siège social est situé au 1600 Amphitheatre Parkway, Mountain View, California 94043, USA.</li>
            </ul>
            ...
            <p>Il est fortement recommandé de lire attentivement l'intégralité des présentes Conditions Générales d'Utilisation avant de consulter le site www.shoesnotincluded.fr (ci-après, le « Site ») ou l'application mobile associée (ci-après, l' « Application mobile »).</p>
            <p>Les présentes Conditions Générales d’Utilisation (ci-après les « CGU ») ont pour objet de déterminer les conditions d’accès et les règles d’utilisation dans lesquelles le Site et l'application offrent l’accès à plusieurs services en ligne.</p>
            <p>L’accès au Site et à l'Application mobile est subordonné au respect des CGU. L’accès au Site et à l'Application mobile est strictement réservé à l’utilisateur (ci-après, « l’Utilisateur ») tel que défini dans les CGU.</p>
            <p>SHOESNOTINCLUDED se réserve le droit de modifier ou de mettre à jour à tout moment, unilatéralement, les CGU au gré des changements ou additions effectués, afin notamment de se conformer à toutes évolutions légales, jurisprudentielles, éditoriales et/ou techniques ainsi qu’aux éventuelles modifications des conditions générales d’utilisation des services de l’Hébergeur.</p>
            ...
            <p>Contribution(s) : désigne(nt) l’ensemble des commentaires ou contenus que les Utilisateurs ont la possibilité de publier sur le Site ou l'Application mobile.</p>
            <p>Éditeur : désigne SHOESNOTINCLUDED.</p>
            <p>Hébergeurs : désigne Netlify et Firebase.</p>
            <p>Information(s) : désigne(nt) l’ensemble des informations et publications accessibles sur le Site et l'Application mobile.</p>
            <p>Site : désigne le site proposé par l’Éditeur sur Internet depuis l’adresse www.shoesnotincluded.fr.</p>
            <p>Application mobile : désigne l'application mobile associée proposée par l’Éditeur sur les stores Android et Apple.</p>
            <p>Utilisateur(s) : désigne(nt) toute personne ayant accès au Site et à l'Application mobile quel que soit le lieu où elle se trouve et les modalités de connexion.</p>

            <h3>3. Objets du site et de l'application mobile</h3>
            ...
            <h3>4. Accès et utilisation du site et de l'application mobile</h3>

            <h4>4.1. Accès au site ou à l'application mobile</h4>
            ...
            <h4>4.3. Durée d’accessibilité</h4>
            ...
            <p>L’Utilisateur reconnaît, qu’en cas de violation des dispositions législatives et/ou des CGU, SHOESNOTINCLUDED peut bloquer et/ou résilier l’accès au Site ou à l'Application mobile, sans notification préalable, avec effet immédiat.</p>

            <h4>4.4. Utilisation du site et de l'application mobile</h4>
            ...
            <p>L’Utilisateur est tenu de respecter les indications techniques suivantes afin de pouvoir accéder au Site et d’utiliser les services proposés de manière optimale. Il s'interdit toute action susceptible d'entraver ou de perturber le bon fonctionnement ou l’accessibilité technique du Site. La configuration minimale requise pour l'accès au Site est la suivante :</p>
            <ul>
              <li>Écran : 1024 X 768 minimum</li>
              <li>Navigateurs minimum : IE 7, Safari 2, Firefox 2, Mozilla Firefox</li>
            </ul>
            <p>L’Utilisateur est tenu de respecter les indications techniques suivantes afin de pouvoir accéder à l'Application mobile et d’utiliser les services proposés de manière optimale. Il s'interdit toute action susceptible d'entraver ou de perturber le bon fonctionnement ou l’accessibilité technique de l'Application mobile. La configuration minimale requise pour l'accès à l'Application mobile est la suivante :</p>
            <ul>
              <li>Écran : 1024 X 768 minimum</li>
            ...
            <p>L’Utilisateur est informé que SHOESNOTINCLUDED peut mettre fin ou modifier les caractéristiques du Site ou de l'Application mobile, à tout moment, sans préavis et sans que l’Utilisateur dispose d’un recours à l’encontre de SHOESNOTINCLUDED.</p>

            <h3>6. Hébergement du Site et de l'Application mobile</h3>
            ...
            <h3>7. Contributions</h3>
            <p>Les Contributions des Utilisateurs sont modérées a posteriori par un modérateur de SHOESNOTINCLUDED en fonction de leur conformité aux lois et règlements français et des exigences rappelées à l'Article 3.4 des CGU et plus largement, pour tout autre motif sérieux.</p>
            ...
            <p>L’Utilisateur s’engage à soumettre à SHOESNOTINCLUDED des informations et des contenus véridiques, faisant apparaître la source et l’auteur de manière distincte dans le cas d’emprunt à une œuvre préexistante.</p>
            ...
            <p>Le téléchargement par l’Utilisateur de certains éléments, notamment textes, photographies ou musiques peut être autorisé par SHOESNOTINCLUDED. Cette fonctionnalité est à l’entière discrétion de SHOESNOTINCLUDED, qui peut la modifier ou la supprimer à tout moment. L’Utilisateur s’engage par conséquent à ne pas émettre de contestation contre SHOESNOTINCLUDED à ce titre. De plus, la constatation d’un téléchargement abusif pourra entraîner de la part de SHOESNOTINCLUDED et/ou de tout tiers concerné la prise de sanctions qui se révéleraient appropriées, notamment en cas de violation des droits de propriété intellectuelle.</p>
            ...
            <p>À l’exception de sites diffusant notamment des informations et/ou contenus ayant un caractère illégal et/ou notamment à caractère politique, religieux, pornographique, un Utilisateur peut créer un lien hypertexte sur un site vers le Site ou l'Application mobile.</p>
            ...
            <h3>10. Garanties & Responsabilité</h3>
            <p>L’Utilisateur s’engage, lors de l’utilisation qu’il fait du Site et de l'Application mobile, à ne pas contrevenir aux dispositions législatives et réglementaires en vigueur, aux bons usages d’Internet, et de la netiquette, et aux CGU.</p>
            ...
            <p>L’Utilisateur garantit SHOESNOTINCLUDED, ainsi que ses sociétés mères, sœurs ou affiliées, ses représentants, ses salariés, ses partenaires, et l’Hébergeur, contre toute demande, réclamation, revendication et/ou recours de toute sorte, résultant de toute violation desdites stipulations.</p>
            ...
            <h3>11. Contact</h3>
            <p>Pour toute question relative au fonctionnement du Site ou de l'Application mobile et aux CGU, vous pouvez nous contacter par courrier postal, à l’adresse suivante :</p>
            <p>
              Anthony Labaere <br />
              25 rue Jules Piedeleu <br />
              44100 NANTES
            </p>
            ...
            <p>En cas de différends relatifs à l’interprétation, la validité ou l’exécution des CGU, l’Utilisateur et SHOESNOTINCLUDED conviennent de déployer leurs meilleurs efforts afin de régler à l’amiable le litige.</p>
            <p>Dans le cas où un accord amiable ne serait pas trouvé, tout éventuel litige se rapportant à l’interprétation ou l’exécution des CGU sera soumis à la compétence des tribunaux de Nantes.</p>
          </LegalNoticesTCUContentContainer>
