...
export const theme: Theme = {
  ...
  filter: {
    mobileXS:
      'drop-shadow(0 0 2rem #fff) drop-shadow(0 0 2rem #fff) drop-shadow(0 0 2rem #fff) ',
    default:
      'drop-shadow(0 0 2rem #fff) drop-shadow(0 0 2rem #fff) drop-shadow(0 0 2rem #fff) drop-shadow(0 0 2rem #fff)',
  },
  tags: {
    easy: {
